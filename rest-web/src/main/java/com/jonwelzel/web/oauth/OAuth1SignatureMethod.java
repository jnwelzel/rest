...
public interface OAuth1SignatureMethod {
	 ...
	 * 
	 * @param baseString a {@link String} that contains the request baseString
	 *            to be signed.
	 ...
	 * 
	 * @param elements a {@link String} that contains the request elements to be
	 *            verified.
	 * @param secrets the secret(s) to use to verify the signature.
	 * @param signature a {@link String} that contains the signature to be
	 *            verified.
