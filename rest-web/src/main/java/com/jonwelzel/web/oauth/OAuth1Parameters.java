...
public class OAuth1Parameters extends HashMap<String, String> {
	...
	/**
	 * Name of parameter containing the consumer domain (e.g.
	 * <code>http://www.domain.com</code>).
	 */
	public static final String CONSUMER_DOMAIN = "oauth_consumer_domain";

	/**
	 * Name of parameter containing the consumer name. Might be a company's name
	...
	/**
	 * Name of parameter containing the token secret. This parameter is never
	 * used in requests. It is part of a response to the request token and
	...
	/**
	 * Name of parameter containing the token secret. This parameter is never
	 * used in requests. It is part of a response to the request token requests.
	 */
	public static final String CALLBACK_CONFIRMED = "oauth_callback_confirmed";

	/**
	 * Default value of the callback URI that should be used during
	 * Authorization flow for Request Token request when the client is not
	 * capable of handling redirects (e.g. the client is a mobile application).
	 */
	 ...
	 * typically containing the number of seconds since January 1, 1970 00:00:00
	 * GMT (epoch).
	 */
	...
	/**
	 * Sets the timestamp. Its value is not validated, but should be a positive
	 * integer, typically containing the number of seconds since January 1, 1970
	 * 00:00:00 GMT (epoch).
	 */
	 ...
	 * timestamp.
	 * 
	 * @param timestamp positive integer, typically number of seconds since
	 *            epoch.
	 * @return this parameters object.
	 */
