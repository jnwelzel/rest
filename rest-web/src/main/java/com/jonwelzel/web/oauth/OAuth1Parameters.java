...
public class OAuth1Parameters extends HashMap<String, String> {
    ...
    /**
     * Name of parameter containing the token secret. This parameter is never used in requests. It is part of a response
     * to the request token and access token requests.
     */
    public static final String TOKEN_SECRET = "oauth_token_secret";

    /**
     * Name of parameter containing the token secret. This parameter is never used in requests. It is part of a response
     * to the request token requests.
     */
    public static final String CALLBACK_CONFIRMED = "oauth_callback_confirmed";

    /**
     * Default value of the callback URI that should be used during Authorization flow for Request Token request when
     * the client is not capable of handling redirects (e.g. the client is a mobile application).
     */
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting protection realm.
     * 
     * @param realm
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting consumer key.
     * 
     * @param consumerKey
     *            the consumer key.
     */
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting token.
     * 
     * @param token
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting signature method.
     * 
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting signature.
     * 
     * @param signature
    ...
    /**
     * Returns the timestamp, a value expected to be a positive integer, typically containing the number of seconds
     * since January 1, 1970 00:00:00 GMT (epoch).
     */
    ...
    /**
     * Sets the timestamp. Its value is not validated, but should be a positive integer, typically containing the number
     * of seconds since January 1, 1970 00:00:00 GMT (epoch).
     */
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting timestamp.
     * 
     * @param timestamp
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting timestamp to the current time.
     * 
     * @return this parameters object.
     */
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting nonce.
     * 
     * @param nonce
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting nonce to a randomly-generated UUID.
     * 
     * @return this parameters object.
     */
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting version.
     * 
     * @param version
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting version to the default value of 1.0.
     * 
     * @return this parameters object.
     */
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting verifier code.
     * 
     * @param verifier
     *            the verifier code.
     * @return this parameters object.
    ...
    /**
     * Builder pattern method to return {@link OAuth1Parameters} after setting callback URL.
     * 
     * @param callback
     *            the callback URL.
     * @return this parameters object.
    ...
    /**
     * Removes (optional) quotation marks encapsulating parameter values in the Authorization header and returns the
     * result.
     */
    private static String dequote(String value) {
        int length = value.length();
        return ((length >= 2 && value.charAt(0) == '"' && value.charAt(length - 1) == '"') ? value.substring(1,
                length - 1) : value);
    }
