...
/**
 * {@link WebApplicationException Web application exception} that is mapped either to
 * {@link javax.ws.rs.core.Response.Status#BAD_REQUEST} (e.g. if problem with OAuth parameters occurs) or
...
public class OAuth1Exception extends WebApplicationException {
     ...
     *            Response status.
     * @param wwwAuthHeader
     *            {@code Authorization} header value of the request that cause the exception.
     */
