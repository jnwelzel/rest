...
/**
 * Request context information used for authorization verification.
 * 
 * @author jwelzel
 * 
 */
public class AuthorizationRequestContext {
    ...
    public AuthorizationRequestContext(String requestUrl, String httpMethod, String requestDateString,
            String nonceToken, String hashedToken) {
