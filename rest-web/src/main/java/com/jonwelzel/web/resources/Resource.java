 ...
 * @author jwelzel
 * 
 * @param <PK> Type of the resource primary key.
...
public interface Resource<PK extends Serializable, T extends AbstractEntity<PK>> {
	 ...
	 * 
	 * @return A list containing all records found or an empty list if none were
	 *         found.
	 */
	public List<T> getResources();

	/**
	 * Retrieve a single record of the {@linkplain T} resource type by its
	 ...
	 * 
	 * @param resouce The object containing the resource data that will be
	 *            created.
	 ...
	 * 
	 * @param resouce The object containing the data that will be updated.
