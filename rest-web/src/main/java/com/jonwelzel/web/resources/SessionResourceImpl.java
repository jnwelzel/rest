...
import static com.jonwelzel.web.oauth.SessionServerFilter.IDENTITY_SESSION_HEADER;
...
public class SessionResourceImpl implements SessionResource {
    ...
    @Override
    @DELETE
    public Response logout(@HeaderParam(IDENTITY_SESSION_HEADER) String sessionToken) {
